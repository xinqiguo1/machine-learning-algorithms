...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        embed_caption_in, cache_embed_in = word_embedding_forward(captions_in, W_embed)
        embed_caption_in = np.transpose(embed_caption_in, (1,0,2))

        h, cache_rnn = rnn_forward(embed_caption_in, h0, Wx, Wh, b)
